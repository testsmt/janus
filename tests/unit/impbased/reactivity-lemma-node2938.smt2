...
(declare-fun SB () Real)
(assert (not (exists ((t1uscore0 Real)) (forall ((ts1uscore0 Real)) (let ((?v_2 (* 2.0 b)) (?v_1 (* d d)) (?v_0 (+ (* amax t1uscore0) v))) (=> (and (and (and (and (and (=> (>= t1uscore0 0.0) (=> (=> (and (<= 0.0 ts1uscore0) (<= ts1uscore0 t1uscore0)) (and (>= (+ (* amax ts1uscore0) v) 0.0) (<= ts1uscore0 ep))) (<= (- (* ?v_0 ?v_0) ?v_1) (* ?v_2 (- M1uscore0 (* (/ 1.0 2.0) (+ (+ (* amax (* t1uscore0 t1uscore0)) (* (* 2.0 t1uscore0) v)) (* 2.0 Z1uscore0)))))))) (>= d 0.0)) (> b 0.0)) (> ep 0.0)) (> amax 0.0)) (>= v 0.0)) (>= SB (+ (/ (- (* v v) ?v_1) ?v_2) (* (+ (/ amax b) 1.0) (+ (* (/ amax 2.0) (* ep ep)) (* ep v)))))))))))
(check-sat)
(exit)
