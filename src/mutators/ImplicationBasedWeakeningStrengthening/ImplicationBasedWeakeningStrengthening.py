...
class ImplicationBasedWeakeningStrengthening(Mutator):
    def __init__(self, script, glbls, args):
        ...
        self.op_rep_rules = [ OperatorReplacement("str.<=", "=", ['String'])
                            ...
                            , OperatorReplacement("str.contains", "str.prefixof", ['String'], reverseArguments=True)
                            , OperatorReplacement("str.contains", "str.suffixof", ['String'], reverseArguments=True)
        ...
        self.string_rules = [ OperatorReplacement("str.<=", "=", ['String'])
                            , OperatorReplacement("str.prefixof", "=", ['String'])
                            , OperatorReplacement("str.suffixof", "=", ['String'])
                            , OperatorReplacement("str.contains", "=", ['String'])
                            , StringEqualityDistinctAppend()
        ...
        self.regex_rules = [ Regex_add_plus()
                           , Regex_add_loop()
                           , Regex_add_opt()
        ...
        self.number_relation_rules = [ OperatorReplacement(">=", "=", ['Int', 'Real'])
                                     , OperatorReplacement(">=", ">", ['Int', 'Real'])
                                     , OperatorReplacement("<=", "<", ['Int', 'Real'])
                                     , OperatorReplacement("<=", "=", ['Int', 'Real'])
                                     , OperatorReplacement("distinct", ">", ['Int', 'Real'])
        ...
        self.core_logic_rules = [ OperatorReplacement("or", "and", ['Bool'])
                                , OperatorReplacement("or", "xor", ['Bool'])
                                , QuantifierSwap()
                                , UninterpretedFunctionEquality()
                                , OrToIte()
        ...
        self.homomorphisms = [
            Homomorphism(R='str.prefixof', r='String', S='<=', s='Int', f='str.len', name='PREFIX-STRLEN')
        ,   Homomorphism(R='str.suffixof', r='String', S='<=', s='Int', f='str.len', name='SUFFIX-STRLEN')
        ,   Homomorphism(R='str.contains', r='String', S='>=', s='Int', f='str.len', name='CONTAINS-STRLEN')
        ,   Homomorphism(R='<=',
                         r='Int',
                         S='str.prefixof',
                         s='String',
                         f=lambda String_1, t: Expr('str.substr', [String_1, Const('0', type='Int'), t], type='String'),
                         n=2,
                         P=lambda ts: Expr('and', [Expr('>=', [t, Const('0', type='Int')], type='Bool') for t in ts], type='Bool'),
                         name='INT-LEQ-SUBSTR-PREFIX')
        ,   Homomorphism(R='>=',
                         r='Int',
                         S='str.suffixof',
                         s='String',
                         f=lambda String_1, Int_1, t: Expr('str.substr', [String_1, t, Expr('str.len', [String_1], type='String')] ,type='String'),
                         n=2,
                         P=lambda ts: Expr('and', [Expr('>=', [t, Const('0', type='Int')], type='Bool') for t in ts] ,type='Bool'),
        ...
        ,   RelationPreservingAutomorphism('=', lambda Int_1, t: Expr('-', [Int_1, t], type='Int'), 'Int', 'EQ-SUB-INT-L')
        ,   RelationPreservingAutomorphism('=', lambda Int_1, t: Expr('-', [t, Int_1], type='Int'), 'Int', 'EQ-SUB-INT-R')
        ,   RelationPreservingAutomorphism('=', lambda Int_1, t: Expr('+', [Int_1, t], type='Int'), 'Int', 'EQ-ADD-INT-L')
        ,   RelationPreservingAutomorphism('=', lambda Int_1, t: Expr('+', [t, Int_1], type='Int'), 'Int', 'EQ-ADD-INT-R')

        ,   RelationPreservingAutomorphism('<=', lambda Int_1, t: Expr('+', [Int_1, t], type='Int'), 'Int', 'LEQ-ADD-INT-L')
        ,   RelationPreservingAutomorphism('>=', lambda Int_1, t: Expr('+', [t, Int_1], type='Int'), 'Int', 'GEQ-ADD-INT-R')
        ,   RelationPreservingAutomorphism('<', lambda Int_1, t: Expr('+', [Int_1, t], type='Int'), 'Int', 'LE-ADD-INT-L')
        ,   RelationPreservingAutomorphism('>', lambda Int_1, t: Expr('+', [t, Int_1], type='Int'), 'Int', 'GE-ADD-INT-R')

        ,   RelationPreservingAutomorphism('=', '-', 'Real', 'EQ-NEG-REAL')

        ,   RelationPreservingAutomorphism('=', lambda String_1, t: Expr('str.++', [String_1, t],type='String'), 'String', 'EQ-STR-CONCAT-L')
        ,   RelationPreservingAutomorphism('=', lambda String_1, t: Expr('str.++', [t, String_1],type='String'), 'String', 'EQ-STR-CONCAT-R')
        ,   RelationPreservingAutomorphism('=', lambda Int_1, Int_2, t: Expr('str.substr', [t, Int_1, Int_2],type='String'), 'String', 'EQ-STR-SUBSTR')
        ,   RelationPreservingAutomorphism('=', lambda String_1, String_2, t: Expr('str.replace', [t, String_1, String_2],type='String'), 'String', 'EQ-STR-REP')
        ,   RelationPreservingAutomorphism('=', lambda String_1, String_2, t: Expr('str.replace_all', [t, String_1, String_2],type='String'), 'String', 'EQ-STR-REPALL')
        ,   RelationPreservingAutomorphism('=', lambda RegLan_1, String_2, t: Expr('str.replace_re', [t, RegLan_1, String_2],type='String'), 'String', 'EQ-STR-REPRE')
        ,   RelationPreservingAutomorphism('=', lambda RegLan_1, String_2, t: Expr('str.replace_re_all', [t, RegLan_1, String_2],type='String'), 'String','EQ-STR-REPREALL')
        ,   RelationPreservingAutomorphism('str.prefixof', lambda String_1, t: Expr('str.++', [String_1, t],type='String'), 'String', 'PRE-STR-CONCAT')
        ,   RelationPreservingAutomorphism('str.suffixof', lambda String_1, t: Expr('str.++', [t, String_1],type='String'), 'String', 'SUF-STR-CONCAT')

        ]

        self.custom_rule_set_1 = self.regex_rules + self.string_rules + [ InstantiateQuantifier() ]
        ...
        if args.rule_set:
            ...
            self.rules = self.string_rules + self.number_relation_rules + self.core_logic_rules + self.regex_rules + self.relation_preserving_automorphisms + self.homomorphisms
    ...
    def get_candidates(self, term, rule, parity):
        ...
        elif term.op == "implies" or (term.op == "=>" and term.subterms[0].type == "Bool"):
    ...
    def get_formulas(self, script):
        return list(map(lambda assrt: assrt.term, filter(lambda cmd: isinstance(cmd, Assert), script.commands)))
